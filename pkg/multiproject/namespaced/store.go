...
// store wraps a Store to provide namespace filtering.
type store struct {
	cache.Store
	namespace string
}
...
func (n *store) Get(obj interface{}) (item interface{}, exists bool, err error) {
...
func (n *store) GetByKey(key string) (item interface{}, exists bool, err error) {
